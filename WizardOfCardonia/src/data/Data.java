...
public class Data {
	...
	public static Enemy[] bosses = {
		new BossEnemy("Plensor", 		 120, 10, 6, 10, 10, 15),
		new BossEnemy("Mejashi",		 250, 20, 12, 10, 30, 30),
		new BossEnemy("Cruden", 		 400, 30, 20, 10, 50, 50)
	};
	...
	static Item[][] items = {{
		...
		new HealItem("Healing Flask", 				ItemRarity.COMMON, 20, 1.10),
		...
		new HealItem("Healing Potion",				ItemRarity.RARE,   40, 1.20),
		...
		new HealItem("Potent Elixir Of Healing",	ItemRarity.EPIC,   80, 1.40),
